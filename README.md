...
If we had an actual database where many factors are rated, the solution for predicting final ratings would be a regression. <b>The necessity for rating prediction algorithms arises from the fact that we don't have sufficient information</b> for such a database to be built. Many people wouldn't willingly give this information due to a variety of reasons, one of the most important of them being security concerns.<br><br> 
The algorithms in surprise library actually do a good job predicting user ratings under these conditions.<br><br><br>
Have a nice day,<br>
Emir Korkut Ünal
